# StackSave AI - Credex Web Development Internship Assignment

StackSave AI is a full-stack web application designed to help development teams and small companies audit their spending on AI tools. Users can input their current tool stack, and the application provides an instant analysis of potential savings, along with actionable recommendations.

This project was built for the Credex Web Development Internship assignment.

**Live URL:** [https://stacksave-ai.vercel.app](https://stacksave-ai.vercel.app) (placeholder)
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/your-repo/stacksave-ai.git
    cd stacksave-ai
    ```
